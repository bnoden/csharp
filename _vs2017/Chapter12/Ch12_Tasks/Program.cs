...
namespace Ch12_Tasks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //MethodB();
            //MethodC();
            WriteLine("Running methods asynchonously on multiple threads.");
            ...
            var taskCallWebServiceAndThenStoredProcedure = Task.Factory
                .StartNew(CallWebService).ContinueWith(previousTask =>
        ...
        static void MethodA() {
            WriteLine("Starting with Method A...");
            Thread.Sleep(3000);
            WriteLine("Finished Method A.");
        }
        static void MethodB() {
            WriteLine("Starting with Method B...");
            Thread.Sleep(2000);
            WriteLine("Finished Method B.");
        }
        static void MethodC() {
            WriteLine("Starting with Method C...");
            Thread.Sleep(1000);
